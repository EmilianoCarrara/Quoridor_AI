...
# Updated GUI size
WINDOW_SIZE = 900  # Increased to better fit the screen
GRID_SIZE = 9
...
def draw_wall(screen, x, y, orientation):
    ...
    if orientation == "H":
        ...
        pygame.draw.rect(screen, BLACK, (y * CELL_SIZE + CELL_SIZE - WALL_THICKNESS, x * CELL_SIZE, WALL_THICKNESS, CELL_SIZE * 2))
    ...
    while running:
        ...
        if game_state:
            ...
            for wall in game_state["walls"]:
                ...
                draw_wall(screen, x, y, orientation)
